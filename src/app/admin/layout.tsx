...
async function navigationProjects() {
  try {
    const [rows] = await db().query<RowDataPacket[]>("SELECT id, name_th FROM projects WHERE status <> 'ARCHIVED' ORDER BY name_th");
